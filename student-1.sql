...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2021 at 11:52 AM
...
(35, '2021-03-24 10:50:39', 'dfdfdf', 'dfdfdfdf', 'svd@g.com', '7410258963', 'Male', 'dh', 'BSC', 'IT', 'II Year', 'jhjh', 'jhjjhj');
...
--
ALTER TABLE `tbl_student_registration`
  MODIFY `stud_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
COMMIT;
