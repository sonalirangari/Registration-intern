...
<!--                <div class="signup-img">
                    <img src="images/axiom1.jpg" class="img-intern" alt=""> 
                </div>-->
                <div class="col-sm-6">
                    <form method="POST" class="register-form" id="register-form" action="BAL/Add_interns" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label for="aadhar_no"><span style="color:red;">*</span>Aadhaar Card No </label>
                                <input class="input-border" maxlength="14" type="text" name="aadhar_no" id="aadhar_no" autocomplete="off" />
                            <span id="aadhar_noError"></span>
                            </div>
                        </div>
                          ...
                          <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input class="input-border" maxlength="10" minlength="10" type="text" name="alternaet_no" id="alternaet_no" autocomplete="off" pattern="^\d{10}$" title="Must have 10 digit number."/>
                            <span id="mobile_noError"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="mobile_no"><span style="color:red;">*</span>Date of Birth</label>
                                <input class="input-border"  type="date" name="date_of_birth" id="date_of_birth" autocomplete="off" />
                            <span id="dateError"></span>
                            </div>
                            <div class="form-group">
                                <label for="mobile_no"><span style="color:red;">*</span>Upload Aadhar Image</label>
                                <input class="input-border"  type="file" name="image" id="image" />
                    ...
                    <div class="form-row">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-submit">
                             <input type="submit" value="Submit Form" class="submit" name="submit" id="submit" onclick="return Intern_Validation();" />&nbsp;&nbsp;&nbsp;
    ...
    <script src="js/Intern_validataion.js" type="text/javascript"></script>
