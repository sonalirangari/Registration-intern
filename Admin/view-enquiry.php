...
<!--          <p class="app-sidebar__user-designation">Frontend Developer</p>-->
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i>View Enquiry</h1>
...
<!--          <li class="breadcrumb-item">View Info</li>-->
          <li class="breadcrumb-item active"><a href="#">View Enquiry</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile-body">
                ...
                <table class="table table-hover table-bordered" id="dataTable">
                  ...
                  <tbody>
                    ...
                    $select=$dbconnect->view_student_reg();
                    ...
                    ?>
                      <tr>
                        ...
                        <td><a  href="view-enquiry-page?id=<?php echo $row['stud_id']; ?>"  class="btn btn-info btn-sm" title="View Detail" data-placement="top" data-toggle="tooltip"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
