...
<!--          <p>Table to display analytical data effectively</p>-->
        ...
        <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item"><a href="view-enquiry">View Enquiry</a></li>
          ...
          <div class="tile">
            ...
            <form class="row" method="post">
                  ...
                  <?php
                    ...
                    $myid = $_REQUEST['id'];
                    $select=$dbconnect->view_single($myid);
        ...
        <?php
          ...
          ?>
                ...
                <div class="form-group col-md-4 align-self-end">
                    <button formaction="view-enquiry.php?id=<?php echo $myid; ?>" class="btn btn-primary"><i class="fa fa-fw fa-lg fa-check-circle"></i> Back </button>
                </div>
              </form>  
            </div>
          </div>
