...
?>
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="images/15_1.jpg" alt="User Image">
        <div>
...
<!--          <p class="app-sidebar__user-designation">Frontend Developer</p>-->
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">View Info</span><i class="treeview-indicator fa fa-angle-right"></i></a>
